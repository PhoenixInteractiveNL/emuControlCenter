...
$i18n['popup'] = array(
	...
	'rom_remove_title%s' =>
		"%s��DB��폜���܂�",
	'rom_remove_msg%s' =>
		"����\n\"%s\"�f�[�^�x�[�X��̃��f�B�A��폜���܂����H\n\n�s���鎖�ɂ��S�Ă�ecc database��̑I�ぃf�B�A��폜���܂��B�������A���f�B�A�ƃf�[�^�̏��̓n�[�h�f�B�X�N����폜����܂���B",
	'rom_remove_done_title' =>
		"DB�͍폜����܂����B",
	'rom_remove_done_msg%s' =>
		"%s�̑S�Ẵf�[�^��ecc-database����폜����܂����B",
	...
	'rom_optimize_title' =>
		"�f�[�^�x�[�X�̍œK��",
	'rom_optimize_msg' =>
		"ecc-�f�[�^�x�[�X���ROM��œK�����܂����H\n\n�f�[�^�x�[�X��œK�����ĉ������B�µ�n�[�h�f�B�X�N����t�@�C����ړ��܂��͍폜�����ꍇ\necc�͎����I�Ƀf�[�^�x�[�X�E���C�ɓ��쟍�A�폜�v���܂��I\n���̃I�v�V�����̓f�[�^�x�[�X�ҏW���̂ݎg�p���܂��B",
	'rom_optimize_done_title' =>
		"�œK�������I",
	'rom_optimize_done_msg%s' =>
		"�v���b�g�t�H�[��\n\n%s\n\n�̃f�[�^�x�[�X�œK�����������܂����I",
	'rom_dup_remove_title' =>
		"ecc-�f�[�^�x�[�X���畡�����ꂽROM��폜���܂����H",
	'rom_dup_remove_msg%s' =>
		"\n\n%s\n\n�̕������ꂽROM��ecc-�f�[�^�x�[�X����폜���܂����H\n\n���̑����emuControlCenter��̃f�[�^�x�[�X�݂̂ł�....\n\n����ɂ��n�[�h�f�B�X�N����t�@�C���͍폜����܂���B",
	...
	'rom_reorg_nocat_msg%s' =>
		"\n\n%s\n\n��ROM�ɑ΂��ăJ�e�S�����I�Ⳃ�Ă܂���I �ҏW�@�\��g�p���ăJ�e�S����ǉB��邩�Aecc-�f�[�^�t�@�C����C���|�[�g���ĉ������B",
	'rom_reorg_title' =>
	...
	'rom_reorg_done__msg%s' =>
		"�t�H���_��̃t�@�C���V�X�e����m�F���A\n\n%s\n\n�R�s�[��L��ɂ��ĉ������B",
	'db_optimize_title' =>
		"�f�[�^�x�[�X�̍œK��",
	'db_optimize_msg' =>
		"�f�[�^�x�[�X�̍œK����s���܂����H\n����ɂ��emuControlCenter-�f�[�^�x�[�X�̃t�B�W�J���T�C�Y�麂����܂��BemuControlCenter���番�͂��ă��f�B�A��폜����ۂ́u�o�L���[���v��g�p���ĉ������B\n\n���̑���ɂ��A�v���P�[�V���������b�t���[�Y���܂��̂ŁA���X���҂��������I�I :-)",
	'db_optimize_done_title' =>
		"�f�[�^�x�[�X�͍œK������܂����I�I",
	'db_optimize_done_msg' =>
		"���Ȃ���ecc-�f�[�^�x�[�X�͍œK������܂����I",
	'export_esearch_error_title' =>
		"eSearch�I�v�V�����͑I�Ⳃ�Ă܂���B",
	'export_esearch_error_msg' =>
		"�G�N�X�|�[�g�@�\��g�p����ꍇ�AeSearch(�g������)��g�p���܂��B����͌���ʂ�o�͂��܂��B���C����ʂŊm�F���ĉ�����",
	'dat_export_filechooser_title%s' =>
		"�I�Ⳃꂽ�f�B���N�g���� %s �̃f�[�^��ۑ����܂��I",	
	'dat_export_title%s' =>
		" %s �̃f�[�^��o��",
	'dat_export_msg%s%s%s' =>
		"\n\n%s\n\n�v���b�g�t�H�[���� %s �f�[�^�t�@�C����\n\n%s�f�B���N�g���ɃG�N�X�|�[�g���܂����H",
	'dat_export_esearch_msg_add' =>
		"\n\necc��eSearch�ɂđI�Ⳃꂽ����G�N�X�|�[�g���܂��I",
	...
	'rom_import_backup_msg%s%s' =>
		"\n\n%s�̃��[�U�[�t�H���_�Ƀo�b�N�A�b�v��쐬���܂����H (%s)\n\n���O�Ƀ��^�f�[�^��C���|�[�g���܂����H",
	'rom_import_title' =>
		"�f�[�^�t�@�C����C���|�[�g���܂����H",
	'rom_import_msg%s%s%s' =>
		"\n\n%s�v���b�g�t�H�[���̃f�[�^��C���|�[�g���܂����H \n\n%s�̃f�[�^�t�@�C��(%s)\n\n�H",
	...
	'dat_clear_backup_msg%s%s' =>
		"\n\n%s (%s)�v���b�g�t�H�[���̃o�b�N�A�b�v��쐬���ċX�����ł����H",
	'dat_clear_done_title%s' =>
		"DB�폜����",
	'dat_clear_done_msg%s%s' =>
		"\n\n%s (%s)\n\n�̑S�Ẵ��^���ecc-�f�[�^�x�[�X���폜����܂����I",
	'dat_clear_done_ifbackup_msg%s' =>
		"\n\n %s�̃��[�U�[�t�H���_�Ƀf�[�^�̃o�b�N�A�b�v��s���܂����B",
	'emu_miss_title' =>
		"�G���[ - �G�~�����[�^�����t����܂���I",
	'emu_miss_notfound_msg%s' =>
		"�I�Ⳃꂽ�G�~�����[�^�����t����܂���B�΂͗L��A�Ԃ͖���ȃG�~�����[�^�ł��B",
	'emu_miss_notset_msg' =>
		"���̃v���b�g�t�H�[���ɂ����ėL��ȃG�~�����[�^��I�ⵂĂ��܂���B",
	'emu_miss_dir_msg%s' =>
		"�I�ⵂ��p�X�̓f�B���N�g���ł��I�I",
	'rom_miss_title' =>
		"�G���[ - ���f�B�A�����t����܂���I",
	'rom_miss_msg' =>
	...
	'maint_empty_history_msg' =>
		'�����ł�history.ini�t�@�C����S�ċ�ɂ��܂��B���̃t�@�C����ecc�t�����g�G���h���ɂ��Ȃ����I�ⵂ��I�v�V�����i��F�B�ꂽ����ROM�j����A�I�ⵂ��p�X���̏���ۑ�����ꏊ�ł��I���̃t�@�C���㊃Z�b�g���Ă�X�����ł����H',
	...
	'status_process_running_msg' =>
		"���̃v���Z�X���N�����Ă��܂��B\n�P�̃v���Z�X�̂݁i���́^�C���|�[�g�^�G�N�X�|�[�g���j�N���\�ł��B���݂̃v���Z�X���I������܂ł��҂��������I",
	'meta_rating_add_error_msg' =>
		"���^�f�[�^�ł̂�ROM��]���o���܂��B\n\n�ҏW��g�Bă��^����쐬���ĉ������B",
	'maint_unset_ratings_title' =>
		"�v���b�g�t�H�[���̕]����O���܂����H",
	'maint_unset_ratings_msg' =>
		"����ɂ��f�[�^�x�[�X�̑S�Ă̕]���㊃Z�b�g���܂��B... �s�BċX�����ł����H",
	'eccdb_title' =>
		"eccdb/romdb",
	'eccdb_statistics_msg%s%s%s%s%s' =>
		"eccdb - ���v:\n\n%s �ǉ�\n%s ����\n%s �G���[\n\n%s �f�[�^�Z�b�g�����I%s",
	'eccdb_webservice_post_msg' =>
		"eccdb/romdb - ���^�f�[�^�x�[�X:\n\nemuControlCenter�̃R�~���j�e�B��T�|�[�g����ɂ́A�ҏW���ꂽ���^�f�[�^��ECCDB(�C���^�[�l�b�g�f�[�^�x�[�X�j�ɒǉB��鎖���o���܂��B(�^�C�g���E�J�e�S���E���ꓙ)\n\n�����CD�g���b�N��CDDB�̗l�Ȃ�̂ł��B\n\n�����m�F����΁Aeccdb�Ƀf�[�^�������I�ɕϊ�����܂��I\n\n��e��ǉB���ɂ̓C���^�[�l�b�g�ɐڑ����K�v�ł��B\n\n�P�O�̃��^�f�[�^�Z�b�g��́A�m�F���ĒǉB���K�v������܂��B",
	'eccdb_error' =>
		"eccdb - �G���[:\n\n�l�b�g�ɐڑ����ĉ�����... eccdb�Ƀf�[�^��ǉB���ɂ̓C���^�[�l�b�g�ɐڑ�����Ă��鎞�̂ݗL��ł��I",
	'eccdb_no_data' =>
		"eccdb - �ǉCf�[�^�����t����܂���:\n\neccdb�ɒǉB���ɂ̓��^�f�[�^��ҏW����K�v������܂��B�ҏW�{�^���韂��čēx���킵�ĉ������I",
		
	/* 0.9 FYEO 9 */
	'rom_dup_remove_msg_preview%s' =>
		"���̃I�v�V�����̓f�[�^�x�[�X���畡�����ꂽROM�쟍�A�������ꂽROM��o�͂��܂��B\n\necc-logs�t�H���_�łÍ�O�t�@�C�����m�F�\�ł��I",
	
	/* 0.9.1 FYEO 3 */
	'img_remove_all_title' =>
		"�S�ẴC���[�W��폜���܂����H",
	'img_remove_all_msg%s' =>
		"����ɂ��I�Ⳃꂽ�Q�[���̑S�ẴC���[�W���폜����܂��I\n\n \n\n%s�̃C���[�W��폜���ċX�����ł����H",
