...
&nbsp;</font></b><table border="0" width="100%" id="table3">
					...
					<table border="0" width="100%" id="table1">
						<tr>
							<td><font size="2">Desktop:</font></td>
							<td><font size="2"><b>%desktop_width_pixel%x%desktop_height_pixel% 
							pixels</b> (%desktop_depth% bit) @ %desktop_refresh_hz% 
							Hz</font></td>
						</tr>
						<tr>
							<td><font size="2">Processor:</font></td>
							<td><font size="2"><b>%proc_speed_mhz% Mhz</b> (%proc_arch%)</font></td>
						</tr>
						<tr>
							<td><font size="2">Memory:</font></td>
							<td><font size="2">total: <b>%mem_total_kb% KB</b>, 
							available: <b>%mem_available_kb% KB</b>, memory load:
							<b>%mem_load_percentage%%</b></font></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							<td><font size="2">Disktype:</font></td>
							<td><font size="2">ECC is running from a <b>%dsk_type_run_from%</b> 
							disk.</font></td>
						</tr>
						<tr>
							<td><font size="2">OS:</font></td>
							<td><font size="2">ECC is running on <b>%os_version%</b> 
							(%os_type%), language: <b>%os_lang%</b></font></td>
						</tr>
					</table>
					</a>
