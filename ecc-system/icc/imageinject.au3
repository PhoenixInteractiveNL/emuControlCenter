...
#include "..\..\ecc-core\thirdparty\autoit\include\GuiListView.au3"
#include "..\..\ecc-core\thirdparty\autoit\include\File.au3"

;Global Variables
Global $ICCServerUrl = "http://icc.phoenixinteractive.mine.nu/"
Global $EccInstallFolder = StringReplace(@Scriptdir, "\ecc-system\icc", "")
...
Global $EccKameleonCode = Iniread($EccInstallFolder & "\ecc-system\kameleon\kameleon.code", "kameleon", "code", "NOT FOUND")
Global $EccKameleon = $EccInstallFolder & "\ecc-system\kameleon\kameleon.au3"
...
GUISetIcon(@ScriptDir & "\imageinject.ico", "", $ECCIMAGEINJECTGUI) ;Set proper icon for the window.
EndFunc ;CreateGUI
