...
FOR %%x IN ("C:\syndev\PHP-Gtk2\lib\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)



REM Check PEAR global ENV, set them if they do not exist

IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\syndev\PHP-Gtk2\lib\pear"

IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\syndev\PHP-Gtk2"

IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\syndev\PHP-Gtk2\php.exe"
