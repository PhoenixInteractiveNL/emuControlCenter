...
class DatFileExport {
	...
	* @author: ascheibel
	*/
	public function __construct($db, $ini, $status_obj)
	{
	...
	*/
	public function save_dat_file_to_fs($path=false)
	{
		...
		if ($user_folder_export!==false) {
			...
			// ECC_INFO
			$release_version = $this->ini->get_ecc_ini_key('ECC_INFO', 'release_version');
			$eccdat_version = $this->ini->get_ecc_ini_key('ECC_INFO', 'eccdat_version');
